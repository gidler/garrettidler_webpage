...
- `/nfl-quick-pick/`: NFL Quick Pick, copied from `../nfl_elimination/index_8bit.html` to `nfl-quick-pick/index.html`. Self-contained, including its pixel font. Update by copying that file again, checking locally, then committing and pushing.
